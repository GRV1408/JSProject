...
function validateForm()
{
    ...
    if(uname.value==="admin" && pwd.value==="password")
    {
...
function codeForm(){
    ...
    //alert(codeval.value);
    if(codeval.value==='NO1'||codeval.value==='NO2'||codeval.value==='NO3'||codeval.value==='NO4'||codeval.value==='NO5')
    {
        //console.log($(".footer"))
...
function bookForm(){
    var codeval="#NO"+Math.floor(Math.random()*1E3);
